...
let package = Package(
    ...
    products: [
      ...
      .package(url: "https://github.com/RxSwiftCommunity/RxAlamofire", from: "6.1.1"),
      ...
      .package(url: "https://github.com/perfectdim/CustomBlurEffectView.git", from: "0.0.3"),
    ], targets: [
    ...
    ], swiftLanguageVersions: [.version("5.6.0")]
)
